...
class SeminarHasilController extends BaseController
{
    ...
    public function index()
    {
            ...
            } elseif (!has_permission('mahasiswa') && !has_permission('admin')) {
    ...
    public function store($id_ujianproposal)
    {
        ...
        $persetujuan_dosen = $this->request->getFile('persetujuan_dosen');
        $persetujuan_dosenName = $persetujuan_dosen->getRandomName();
        $berita_acara = $this->request->getFile('berita_acara');
        $berita_acaraName = $berita_acara->getRandomName();
        ...
        $rules = [
            ...
            'persetujuan_dosen' => [
                'rules' => "uploaded[persetujuan_dosen]|ext_in[persetujuan_dosen,pdf]|max_size[persetujuan_dosen,2048]",
                'errors' => [
                    'uploaded' => 'File harus diupload',
                    'ext_in' => 'File berupa pdf',
                    'max_size' => 'Size maks 5 MB',
            ...
            'berita_acara' => [
                'rules' => "uploaded[berita_acara]|ext_in[berita_acara,pdf]|max_size[berita_acara,2048]",
                'errors' => [
                    'uploaded' => 'File harus diupload',
                    'ext_in' => 'File berupa pdf',
                    'max_size' => 'Size maks 5 MB',
        ...
        if ($this->validate($rules)) {
            $data = [
                ...
                'persetujuan_dosen' => $persetujuan_dosenName,
                'berita_acara' => $berita_acaraName,
        ...
        //    dd($data);
            ...
            $persetujuan_dosen->move('simta_assets/seminarhasil/persetujuan_dosen/', $persetujuan_dosenName);
            $berita_acara->move('simta_assets/seminarhasil/berita_acara/', $berita_acaraName);
