...
class PenilaianAkhirModel extends Model
{
    ...
    protected $allowedFields    = ['id_hasilakhir', 'id_ujianproposal', 'nilai_ujianproposal', 'nilai_seminarhasil', 'nilai_ujianta', 'hasilakhir', 
                                    ];
    ...
    public function getHasilakhir()
    {
        ...
        $builder->select('simta_hasilakhir.*,  simta_ujianproposal.*');
