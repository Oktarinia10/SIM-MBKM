...
$routes->group('simta/bobotpenilaian', ['filter' => 'login'], static function ($routes) {
    ...
    $routes->get('tambah/(:any)', 'Simta\BobotPenilaianController::tambah/$1');
    $routes->post('simpan/(:any)', 'Simta\BobotPenilaianController::simpan/$1');
...
$routes->group('simta/pengajuanbimbingan', ['filter' => 'login'], static function ($routes) {
    ...
    $routes->get('tambah', 'Simta\PengajuanBimbinganController::tambah');
    $routes->post('store', 'Simta\PengajuanBimbinganController::store');
