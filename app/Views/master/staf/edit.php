                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <?php if((string) $uri == 'http://localhost:8080/staf/user/edit/'. $staf->id_staf) : ?>
                                <form method="POST" action="<?= base_url('staf/user/update/'. $staf->id_staf); ?>">
                                    <?php elseif((string) $uri == 'http://localhost:8080/staf/edit/'. $staf->id_staf): ?>
                                    <form method="POST" action="<?= base_url('staf/update/'. $staf->id_staf); ?>">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <?php elseif((string) $uri == 'http://localhost:8080/staf/user/update/' . $staf->id_staf) : ?>
                                            <a href="<?= base_url('users'); ?>" class="btn btn-warning">Kembali</a>
                                            <?php elseif((string) $uri == 'http://localhost:8080/staf/update/' . $staf->id_staf) : ?>
                                            <a href="<?= base_url('staf'); ?>" class="btn btn-warning">Kembali</a>
                                            <?php endif; ?>
                                    </form>
                            </div>
