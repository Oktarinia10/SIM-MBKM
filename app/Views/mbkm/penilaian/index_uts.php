...
<main role="main" class="main-content">
    <div class="row my-3">
        <div class="col-12">
            <div class="row mb-1">
                <div class="col-sm-4 col-lg-5 mx-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-7">
                                <div class="card shadow" style="width: 589px; height: 260px;">
                                    <div class="card-header">
                                        <strong class="card-title">Grafik UTS</strong>
                                    </div>
                                    <div class="card-body mx-1">
                                        <canvas id="grafikpenilaianuts" width="589" height="200"></canvas>
                                        <script
                                            ...
                                            options: {
                                                ...
                                                scales: {
                                                    ...
                                                    xAxes: [{
                                                        scaleLabel: {
                                                            display: true,
                                                            labelString: 'Nilai UTS' // Ganti dengan label yang diinginkan untuk sumbu X
                                                        }
                                                    }]
                                                },
                                                plugins: {
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item"
                                                ...
                                                href="<?= base_url('mbkm/penilaian/pdf-uts-mtr/' . $a->id_mbkm_fix) ?>">Penilaian
                                                Mitra</a>
                                        </div>
                                        <?php else: ?>
                                        -
                    ...
                    <?php if(has_permission('admin')|| has_permission('koor-mbkm')): ?>
                        .append('<tr><td>' + ((i++) + 1) + '</td><td>' + item
                            ...
                            ((item.nilai_final_uts != null) ?
                                ...
                                ((item.nilai_dosen_uts == null) ? 'none' : '') +
                                '" href="' + url_cetak_dsn +
                                '">Penilaian Prodi</a><a class="dropdown-item" style="display:' +
                                ((item.nilai_mitra_uts == null) ? 'none' : '') +
                                '" href="' + url_cetak_mtr +
