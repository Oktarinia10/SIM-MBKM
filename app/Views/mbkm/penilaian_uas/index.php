            ...
            success: function(data) {
                ...
                $.each(data, function(i, item) {
                    var url_uas_dsn =
                        ...
                        '/' + item.id_mbkm_fix;
                    var url_cetak_dsn =
                        '<?= base_url('mbkm/penilaian/uas/pdf-uas-dsn/') ?>' +
                        '/' + item.id_mbkm_fix;
                    var url_cetak_mtr =
                        '<?= base_url('mbkm/penilaian/uas/pdf-uas-mtr/') ?>' +
                        '/' + item.id_mbkm_fix;
                    $('#dataTable-1 tbody')
                    <?php if(has_permission('admin')|| has_permission('koor-mbkm')): ?>
                        .append('<tr><td>' + ((i++) + 1) + '</td><td>' + item
                            ...
                            ((item.nilai_final_uas != null) ?
                                ...
                                ((item.nilai_dosen_uas == null) ? 'none' : '') +
                                '" href="' + url_cetak_dsn +
                                '">Penilaian Prodi</a><a class="dropdown-item" style="display:' +
                                ((item.nilai_mitra_uas == null) ? 'none' : '') +
                                '" href="' + url_cetak_mtr +
