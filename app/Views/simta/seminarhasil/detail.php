                        ...
                        <table class="table">
                            <?php foreach($seminarhasil as $semhas) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?=
                                        date('H:i', round($semhas->jam_mulai/1000))
                                        ?> WIB
                                        </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <?=
                                        date('H:i', round($semhas->jam_selesai/1000))
                                        ?> WIB
                                        </td>
                                </tr>
                                <tr>
                    ...
                    <div class="col-md-6">
                        <div class="card shadow">
                            ...
                            <?php foreach($seminarhasil as $semhas) : ?>
                                ...
                                <p>
                                    <?php if($semhas->persetujuan_dosen == null) : ?>
                                    <span class="badge badge-primary text-uppercase">belum diupload</span>
                                    <?php else : ?>
                                    <a
                                        href="<?= base_url('simta/seminarhasil/download_persetujuan_dosen/' . $semhas->id_seminarhasil); ?>">Download</a>
                                    <?php endif; ?>
                                </p>
                                <h5>Berita Acara</h5>
                                <p>
                                    <?php if($semhas->berita_acara == null) : ?>
                                    <span class="badge badge-primary text-uppercase">belum diupload</span>
                                    <?php else : ?>
                                    <a
                                        href="<?= base_url('simta/seminarhasil/download_berita_acara/' . $semhas->id_seminarhasil); ?>">Download</a>
                                    <?php endif; ?>
                                </p>
                                ...
                                <p>
                                    ...
                                    <?php else : ?>
                                    <a
                                        href="<?= base_url('simta/seminarhasil/download_revisi_proposal/' . $semhas->id_seminarhasil); ?>">Download</a>
                                    <?php endif; ?>
                                </p>
                            <?php endforeach?>
                            </div>
