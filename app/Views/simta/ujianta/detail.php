                        ...
                        <table class="table">
                            <?php foreach($ujianta as $ujita) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?=
                                        date('H:i', round($ujita->jam_mulai/1000))
                                        ?> WIB
                                        </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <?=
                                        date('H:i', round($ujita->jam_selesai/1000))
                                        ?> WIB
                                        </td>
                                </tr>
                                <tr>
                        ...
                        <div class="card shadow">
                            ...
                            <?php foreach($ujianta as $ujita) : ?>
                                ...
                                <p>
                                    ...
                                    <?php else : ?>
                                    <a
                                        href="<?= base_url('simta/ujianta/download_krs/' . $ujita->id_ujianta); ?>">Download</a>
                                    <?php endif; ?>
                                </p>
                                ...
                                <p>
                                    ...
                                    <?php else : ?>
                                    <a
                                        href="<?= base_url('simta/ujianta/download_transkripnilai/' . $ujita->id_ujianta); ?>">Download</a>
                                    <?php endif; ?>
                                </p>
                                ...
                                <p>
                                    ...
                                    <?php else : ?>
                                    <a
                                        href="<?= base_url('simta/ujianta/download_rekomendasi_dospem/' . $ujita->id_ujianta); ?>">Download</a>
                                    <?php endif; ?>
                                </p>
                                ...
                                <p>
                                    ...
                                    <?php else : ?>
                                    <a
                                        href="<?= base_url('simproposal/ujianta/download_revisi_proposal/' . $ujita->id_ujianta); ?>">Download</a>
                                    <?php endif; ?>
                                </p>
                            <?php endforeach?>
                            </div>
