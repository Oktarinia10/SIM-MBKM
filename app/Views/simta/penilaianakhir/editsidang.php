                ...
                <div class="row my-4">
                    ...
                    <div class="col">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <!-- table -->
                                <form method="POST" action="<?= base_url('simta/penilaianakhir/updatesidang/' . $ujianproposal->id_ujianproposal); ?>"
                                    enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    <?php if(has_permission('admin')) : ?>
                                        <div class="form-group mb-3">
                                            <label for="address-wpalaceholder">Nilai Ujian Tugas Akhir</label>
                                            <input type="number" step="0.01" id="address-wpalaceholder" name="nilai_ujianta"
