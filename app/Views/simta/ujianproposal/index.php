                                        ...
                                        <?php foreach ($ujianpropsal as $ujipro) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if(has_permission('mahasiswa') && !has_permission('admin') && !has_permission('dosen')) : ?>
                                                        <a class="dropdown-item"
                                                        href="<?=base_url("simta/seminarhasil/tambah/$ujipro->id_ujianproposal");?>">Tambah Seminar Hasil</a>
                                                        <a class="dropdown-item"
                                                        href="<?=base_url("simta/ujianta/tambah/$ujipro->id_ujianproposal");?>">Tambah Ujian Tugas Akhir</a>
                                                        <?php foreach ($ujianpropsal as $ujipro1) {
                                                            $tanggal_ujian = date('d F Y',($ujipro1->tanggal/1000));
                                                            ...
                                                            if ($ujipro1->status_up == 'lulus dengan revisi' && $tanggal < $tanggal_sekarang) { ?>
                                                                <a class="dropdown-item" href="<?= base_url("simta/ujianproposal/revisi/$ujipro1->id_ujianproposal"); ?>">Revisi</a>
                                                            <?php }
                                                        } ?>           
                                                    <?php endif; ?>
                                                    <a class="dropdown-item"
