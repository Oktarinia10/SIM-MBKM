                        ...
                        <table class="table">
                            <?php foreach($ujianproposal as $ujipro) : ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?=
                                        date('H:i', round($ujipro->jam_mulai/1000))
                                        ?> WIB
                                        </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <?=
                                        date('H:i', round($ujipro->jam_selesai/1000))
                                        ?> WIB
                                        </td>
                                </tr>
                                <tr>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <?php foreach ($ujianproposal as $ujipro) {
                                                            ...
                                                            if ($ujipro->$tanggal = $tanggal_sekarang) { ?>
                                                                <a class="dropdown-item" href="<?= base_url("simta/ujianproposal/editstatus/$ujipro->id_ujianproposal"); ?>">Penilaian</a>
                                                            <?php }
                                                        } ?>   
                                                        <?php endif; ?>
                                                    </div>
                                        ...
                                        <div class="card shadow">
                                            <div class="card-body">
                                                <?php foreach($ujianproposal as $ujipro) : ?>
                                                    ...
                                                    <p>
                                                        <?php if($ujipro->transkrip_nilai == null) : ?>
                                                            <span class="badge badge-primary text-uppercase">belum diupload</span>
                                                                <?php else : ?>
                                                                    <a href="<?= base_url('simta/ujianproposal/download_transkripnilai/' . $ujipro->id_ujianproposal); ?>">Download</a>
                                                                <?php endif; ?>
                                                    </p>
