    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row">
                    <div class="col-sm-6">
                        <h2 class="mt-2 page-title">Halaman Tambah Data Dosen Pembimbing Tugas Akhir</h2>
                    </div>
                ...
                <div class="row my-4">
                    ...
                    <div class="col">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                <!-- table -->
                                <form method="POST" action="<?= base_url('simta/pengajuanjudul/updatepembimbing/' . $pengajuanjudul->id_pengajuanjudul); ?>"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="id_staf"
                                            ...
                                            <option value="<?= $s->id_staf ?>"
                                                <?= ($pengajuanjudul->id_staf) == $s->id_staf ? 'selected' : '' ?>><?= $s->nama ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
