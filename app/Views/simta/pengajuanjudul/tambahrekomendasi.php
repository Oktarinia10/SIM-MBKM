                ...
                <div class="row my-4">
                    <div class="col">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data" action="<?= base_url('simta/pengajuanjudul/storepengujipengajuanjudul/' . $pengajuanjudul->id_pengajuanjudul); ?>" id="pengajuanjudul-form">
                                    <?= csrf_field(); ?>
