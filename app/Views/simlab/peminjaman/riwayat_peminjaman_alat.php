                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right text-sm">
                            ...
                            <li class="breadcrumb-item"><a href="<?=base_url('simlab/peminjaman')?>">Peminjaman</a></li>
                    ...
                    <div class="card-body">
                        <table class="table datatables" id="dataTable-1">
                            ...
                            <tbody>
                                ...
                                <?php if($pma->status_ajuan == 'Disetujui' && $pma->status_peminjaman == 'Dikembalikan'|| $pma->status_ajuan == 'Ditolak') :?>
                                <tr>
                                    <td style="width: 1%;"><?=$no++?></td>
                                    <td style="width: 20%;"><?php if ($pma->nama_mahasiswa): ?>
                                        <?=$pma->nama_mahasiswa?>
                                        <?php elseif ($pma->nama_staff): ?>
                                        <?=$pma->nama_staff?>
                                        <?php endif;?>
                                    </td>
                                    <td style="width: 10%;"><?php if ($pma->nama_mahasiswa): ?>
                                        <?=$pma->nim?>
                                        <?php elseif ($pma->nama_staff): ?>
                                        <?=$pma->nip?>
                                        <?php endif;?>
                                    ...
                                    <td>
                                        <?php if ($pma->status_ajuan == 'Disetujui') {?>
                                    ...
                                    <td>
                                        <?php if ($pma->status_ajuan == 'Disetujui'): ?>
                                        <?=date("d M Y, H:i", round($pma->waktu_konfirmasi_kembali / 1000))?> WIB
                                        <?php elseif ($pma->status_ajuan == 'Ditolak'): ?>
                                        <span class="badge badge-danger">Status Pengajuan Ditolak</span>
                                        <?php endif;?>
                                    </td>
                                    <td><button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal"
                                            data-target="#detailpinjamalat" data-id="<?=$pma->id_pinjam_alat?>">
